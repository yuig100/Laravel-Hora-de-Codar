    ...
    <div class="row">
        ...
        <div id="info-container" class="col-md-6">
            ...
            <form action="/events/join/{{$event->id}}" method="POST">
                ...
                <a href="/events/join/{{$event->id}}" class="btn btn-primary" id="events-submit" onclick="event.preventDefault(); this.closest('form').submit();">Confirmar presença</a>
            </form>
            @else
